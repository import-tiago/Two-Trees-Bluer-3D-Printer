...
## Firmware
Firmware|[Marlin 3D Printer Firmware 2.0.x](https://github.com/MarlinFirmware/Marlin) (from bugfix-2.0.X in 3/21/2021) + [BlueR v3 Marlin Configurations](https://github.com/MarlinFirmware/Configurations/tree/import-2.0.x/config/examples/Two%20Trees/BlueR/BlueR%20V3) (from bugfix-2.0.X in 3/21/2021) + Personal Customization|
--- | ---
